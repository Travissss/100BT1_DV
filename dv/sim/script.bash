...
## Engineer: 		Travis
## 
## Create Date: 	03/24/2021 Wed 20:41
...
export DUT_ROOT="/proj/fir0/wa/yyunxiao/yyx_downloads/git_download/mcdf/rtl"
export MCDF_ROOT="/proj/fir0/wa/yyunxiao/yyx_downloads/git_download/mcdf/dv"
...
TB="-f $MCDF_ROOT/etc/tb.f"
CASEDIR=$MCDF_ROOT/tc

echo "DV_ROOT is: $MCDF_ROOT" 
echo "CASEDIR is: $CASEDIR" 
echo "All the Testcase includes: $ListL1" 
##################################################################################
##Compile & run options
##support SV, UVM, Verdi? FMCDFB
VCS_OPT="	-sverilog 
			-timescale=1ns/1ns
